    ...
    <table class="pc-project-body" style="table-layout: fixed; width: 100%; min-width: 550px; background-color: #f4f4f4;" bgcolor="#f4f4f4" border="0" cellspacing="0" cellpadding="0" role="presentation">
        <tr>
            <td align="center" valign="top" style="width:auto;">
                <table class="pc-project-container" align="center" style="width: 550px; max-width: 550px;" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td style="padding: 40px 0px 20px 0px;" align="left" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                <tr>
                                    <td valign="top">
                                        <!-- BEGIN MODULE: Logo Medium -->
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                <a class="pc-font-alt" href="https://www.ipconfigure.com" target="_blank" style="text-decoration: none; display: inline-block; vertical-align: top;">
                                                                    <img src="https://postcards-cdn.designmodo.com/images-cdn/ab10a501c4a76e6cb88b26af2aaf2136.png" width="258" height="50" alt="IPConfigure" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; object-fit: contain; height: 50px; max-height: 100%; width: auto; border: 0;" />
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </table>
...
-->
                                ...
                                <tr>
                                    <td valign="top">
                                        ...
                                        <table style="border-collapse: separate; border-spacing: 0px;" width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                            <tr>
                                                <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 10px 40px 40px 40px; height: unset; border-right: 1px solid #a9b3bb80; border-left: 1px solid #a9b3bb80; background-color: #ffffff;" bgcolor="#ffffff">
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                <img src="https://postcards-cdn.designmodo.com/images-cdn/2dcf689d90c387be3e74fb4d5333da6b.png" width="60" height="59" alt="" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; object-fit: contain; width: 60px; height: auto; max-width: 100%; border: 0;" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr>
                                                            <td align="center" valign="top" style="padding: 10px 0px 40px 0px; height: auto;">
                                                                ...
                                                                <table class="pc-width-fill pc-w620-gridCollapsed-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr class="pc-grid-tr-first pc-grid-tr-last">
                                                                        ...
                                                                        <td class="pc-grid-td-last pc-w620-itemsSpacings-0-20" align="left" valign="top" style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 20px;">
                                                                            <table style="width: 100%;" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                                <tr>
                                                                                    <td class="pc-w620-halign-left pc-w620-valign-top" align="right" valign="top">
                                                                                                                            ...
                                                                                                                            <table class="pc-width-hug pc-w620-gridCollapsed-0" align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                <tr class="pc-grid-tr-first pc-grid-tr-last">
                                                                                                                                    <td class="pc-grid-td-first pc-w620-itemsSpacings-10-0" valign="middle" style="padding-top: 0px; padding-right: 10px; padding-bottom: 0px; padding-left: 0px;">
                                                                                                                                        <a class="pc-font-alt" href="https://www.instagram.com/ipconfigure/" target="_blank" style="text-decoration: none; display: inline-block; vertical-align: top;">
                                                                                                                                            <img src="https://postcards-cdn.designmodo.com/images-cdn/293e174e097d13c8322e2200ff1949b0.png" class="" width="15" height="15" style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 15px; height: 15px;" alt="" />
                                                                                                                                        </a>
                                                                                                                                    </td>
                                                                                                                                    <td class="pc-w620-itemsSpacings-10-0" valign="middle" style="padding-top: 0px; padding-right: 10px; padding-bottom: 0px; padding-left: 10px;">
                                                                                                                                        <a class="pc-font-alt" href="https://www.youtube.com/@ipconfigure9192" target="_blank" style="text-decoration: none; display: inline-block; vertical-align: top;">
                                                                                                                                            <img src="https://postcards-cdn.designmodo.com/images-cdn/28c06e5b93c90b46ee55be1f3b0baf36.png" class="" width="15" height="15" style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 15px; height: 15px;" alt="" />
                                                                                                                                        </a>
                                                                                                                                    </td>
                                                                                                                                    <td class="pc-grid-td-last pc-w620-itemsSpacings-10-0" valign="middle" style="padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 10px;">
                                                                                                                                        <a class="pc-font-alt" href="https://www.linkedin.com/company/ipconfigure/" target="_blank" style="text-decoration: none; display: inline-block; vertical-align: top;">
                                                                                                                                            <img src="https://postcards-cdn.designmodo.com/images-cdn/8d71cf46bda286707c865e47be84dbc4.png" class="" width="15" height="15" style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 15px; height: 15px;" alt="" />
                                                                                                                                        </a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </table>
